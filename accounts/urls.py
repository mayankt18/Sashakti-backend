...
urlpatterns = [
    path('', views.home),
    path('accounts/register', views.CreateUserView.as_view(), name='register'), # k
    path('accounts/login', views.login, name='login'), # k
    path('accounts/logout', views.logout, name="logout"), # k
